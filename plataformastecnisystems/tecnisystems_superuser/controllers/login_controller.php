<?php
	...
	{
		$result_search_user = search_super_user($valid_mail);
		...
		if ($result_search_user != false)
		{
			...
			{
				session_start();
				$_SESSION["superUser"] = [$result_search_user[5],$result_search_user[1],$result_search_user[3],"Super Usuario",$result_search_user[0]];

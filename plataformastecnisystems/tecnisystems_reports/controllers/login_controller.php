<?php
	...
	{
		$result_search_user = search_technical_user($valid_mail);
		...
		if ($result_search_user != false)
		{
			...
			{
				session_start();
				$_SESSION["technical_user"] = [$result_search_user[0],$result_search_user[1],$result_search_user[2],$result_search_user[4],$result_search_user[5]];

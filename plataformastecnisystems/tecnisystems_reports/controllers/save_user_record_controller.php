<?php
  ...
  if (search_state_user($_SESSION["technical_user"][0],$_SESSION["technical_user"][2],$_SESSION["technical_user"][4]))
  {
    ...
    $id = $_SESSION["technical_user"][4];

    if (insert_record($content,$date,$time,$id_lat_lon, $id, 1))
    {

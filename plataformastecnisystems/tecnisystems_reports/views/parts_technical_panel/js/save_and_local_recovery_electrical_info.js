let saveBTN = document.getElementById("save_form_electrical");
let inputs_elements = document.querySelectorAll("#report_electrical_form input[type='text']");
let inputs_elements_search = document.querySelectorAll("#report_electrical_form input[type='search']");
let inputs_elements_number = document.querySelectorAll("#report_electrical_form input[type='number']");
let inputs_elements_date = document.querySelectorAll("#report_electrical_form input[type='date']");
let inputs_elements_email = document.querySelectorAll("#report_electrical_form input[type='email']");
let inputs_radio = document.querySelectorAll("#report_electrical_form input[type='radio']");
let textarea_elements = document.querySelectorAll("#report_electrical_form textarea");
...
window.addEventListener("load",function(){
  ...
  if(window.localStorage.length > 0 && tt == "eléctrico"){
